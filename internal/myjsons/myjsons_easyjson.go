...
func easyjsonEd95e889DecodeGithubComDmad1989UrlcutInternalMyjsons(in *jlexer.Lexer, out *Response) {
...
func easyjsonEd95e889EncodeGithubComDmad1989UrlcutInternalMyjsons(out *jwriter.Writer, in Response) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonEd95e889DecodeGithubComDmad1989UrlcutInternalMyjsons1(in *jlexer.Lexer, out *Request) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonEd95e889EncodeGithubComDmad1989UrlcutInternalMyjsons1(out *jwriter.Writer, in Request) {
	out.RawByte('{')
	first := true
	_ = first
	{
